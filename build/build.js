...
(async function build() {
    ...
    const outFilePath = `${distDirPath}/azure-maps-selection-control.js`;
    const outMinFilePath = `${distDirPath}/azure-maps-selection-control.min.js`;

    const cssInPath = "./src/css/azure-maps-selection-control.less";
    const cssOutPath = `${distDirPath}/azure-maps-selection-control.css`;
    const cssOutMinPath = `${distDirPath}/azure-maps-selection-control.min.css`;    
    ...
    if (!args.isNpmBuild) {
        ...
        rollupInputOps = {
            external: ["azure-maps-control", "azure-maps-drawing-tools"],
            onwarn: rollupWarn,
            input: inputPath,
            plugins: [
                nodeResolve({
